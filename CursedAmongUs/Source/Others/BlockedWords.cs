...
namespace CursedAmongUs.Source.Others
{
	internal static class CursedBlockedWords
	{
		...
		{
			"sus", "discord", "comma", "minecraft", "roblox", "cod", "poop", "red", "pgg", "cursed", "mod", "curse", "love", "trump", "biden", "donald", "joe", "hillary", "clinton", "barack", "obama", "germany", "german", "italy", "italian", "communist", "lmfao", "lmao", "fml", "gtfo", "omfg", "wtf", "ffs", "sext", "vented", "chasing", "nudes", "coll", "milk", "banana", "cnn", "fox", "npr", "msnbc", "ironman", "2024", "2020", "france", "french", "francaise", "francais", "fortnite", "brazil", "brazilian", "amogus"
		};
